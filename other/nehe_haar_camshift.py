...
# draw pyramid3
    ...
    def update(self):
        """ 1. captureImage
            2. if you don't have a centroid or if camshift no longer knows where the face is, 
        ...
        if roi_selection == None or face_centroid_camshift == None:
            ...
            # print roi_selection
            face_centroid_camshift = camshift_track(roi_selection, img) #2.2 run camshift
        else:
    ...
    def update_camera(self, face_centroid_camshift):
        xposition = (face_centroid_camshift[0]-640)/float(1000)
        yposition = (face_centroid_camshift[1]-360)/float(1000)
